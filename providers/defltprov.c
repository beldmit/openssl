...
static const OSSL_ALGORITHM deflt_asym_kem[] = {
    ...
    { PROV_NAMES_SecP256r1MLKEM768, "provider=default,fips=yes", ossl_mlx_kem_asym_kem_functions },
    { PROV_NAMES_SecP384r1MLKEM1024, "provider=default,fips=yes", ossl_mlx_kem_asym_kem_functions },
#endif
